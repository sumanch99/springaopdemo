...
public class LoginAspect {
	...
	// Type your code here
	@Before(value = "execution(public void com.cts.SpringAopDemo.EasyBank.doDeposit(..)) || execution(public void com.cts.SpringAopDemo.EasyBank.showBalance(..))")
	...
	// Type your code here
	@AfterThrowing(value="execution(public * com.cts.SpringAopDemo.EasyBank.*(..)))")
